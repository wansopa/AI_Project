...
page = st.sidebar.radio("Go to", ["Homepage","AI Project", "Contact Us"])
...
if page == "Homepage":
    ...
    st.image("https://content.wepik.com/statics/111987164/preview-page0.jpg", caption="Your Amazing Banner Image", use_column_width=True)
    st.write("""
